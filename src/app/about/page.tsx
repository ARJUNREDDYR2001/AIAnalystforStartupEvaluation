          ...
          <Card>
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>
                  <strong>Document Discrepancy Detection:</strong> Automatically scan pitch decks, financial statements, and other documents for inconsistencies. Our system flags conflicting numbers and claims, ensuring what you read on page 2 aligns with what's on page 20.
                </li>
                <li>
                  <strong>Peer Benchmarking:</strong> Context is everything. Benchmark a startup's key metrics like ARR and burn multiple against its industry peers. A dynamic radar chart provides an instant visual comparison, helping you see where a company leads and where it lags.
                </li>
                <li>
